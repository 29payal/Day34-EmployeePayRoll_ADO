...
namespace EmployeeManagementSalaryDetailModel
{
    public class Salary
    {
        private static SqlConnection ConnectionSetup()
        {
          return new SqlConnection("Data Source = (localdb)\\MSSQLLocalDB; Initial Catalog = DemoADO; Integrated Security = True");
        }
